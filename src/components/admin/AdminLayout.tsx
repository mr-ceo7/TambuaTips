...
import {
  ...
  Bell, ChevronLeft, ChevronRight, LogOut, Shield, Menu, X, Megaphone, Presentation, Handshake, Smartphone
} from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { path: '/admin/legacy-mpesa', icon: Smartphone, label: 'Legacy M-Pesa', end: false },
        ...
        <div className="h-16 flex items-center px-4 border-b border-zinc-800/60 gap-3 shrink-0">
          ...
          {!collapsed && (
            <div className="overflow-hidden">
              <p className="text-sm font-bold text-white font-display tracking-wide">TambuaTips</p>
