...
import { Zap, Lock, Star, Trophy, Crown, ChevronRight, Target, Plus, Check } from 'lucide-react';
      ...
      {locked ? (
        ...
        >
          ...
          <p className="text-xs text-zinc-500 font-bold uppercase tracking-wider">
            {CATEGORY_LABELS[tip.category]?.minTier === 'premium' ? 'Premium' : CATEGORY_LABELS[tip.category]?.minTier === 'standard' ? 'Standard' : 'Basic'} Plan Required
          </p>
        </button>
      ) : (
        <>
            ...
            <div className="mb-3">
              ...
              <div className="grid grid-cols-3 gap-2">
                {tip.bookmakerOdds.map(bo => {
                  ...
                  const alreadyInSlip = isInSlip && !justAdded;
                  return (
                    <button
                      key={bo.bookmaker}
    ...
    <div className="bg-zinc-900/60 border border-zinc-800 rounded-2xl overflow-hidden">
      <div className="p-5">
        ...
        <button
          ...
          className="w-full py-2.5 bg-gold-500 text-zinc-950 font-bold rounded-xl text-sm hover:bg-gold-400 transition-all"
        >
